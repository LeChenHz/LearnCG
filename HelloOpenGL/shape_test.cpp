...
//#include "common/shape/ShapeFactory.h"
//
//#include <iostream>
//#include <string>
//using namespace std;
...
//	Shape *cube = shapeFactory.getShape(Cube_Type);
//	Shape *sphere = shapeFactory.getShape(Sphere_Type);
//	// 着色器
//	Shader* shader = new  Shader("shaders\\base\\base_vs.glsl", "shaders\\base\\base_fs.glsl");
//	Shader* sphere_shader = new  Shader("shaders\\sphere\\sphere_vs.glsl", "shaders\\sphere\\sphere_fs.glsl");
//
